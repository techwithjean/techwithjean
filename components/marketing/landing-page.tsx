      ...
      <main>
        ...
        <section className="relative overflow-hidden border-b border-border">
          ...
          <div className="relative mx-auto flex max-w-7xl flex-col gap-6 px-4 py-20 sm:px-6 sm:py-28 lg:py-32">
            ...
            <h1 className="max-w-2xl text-balance font-heading text-4xl font-extrabold leading-tight tracking-tight sm:text-5xl lg:text-6xl">
            ...
            <p className="max-w-xl text-pretty text-lg leading-relaxed text-muted-foreground">
              Join the free soccer prediction game where you call every score,
              run private leagues with friends, and climb a live leaderboard all
        ...
        <section className="border-t border-border">
          <div className="mx-auto max-w-4xl px-4 py-20 text-center sm:px-6">
            ...
            <p className="mx-auto mt-4 max-w-xl text-pretty text-muted-foreground">
              Create your free account, start a league, and get your first
              predictions in before the next kickoff.
            </p>
